    ...
    public class CampaignResumeSellOutRepository : ICampaignResumeSellOutRepository
    {
        ...
        public async Task<IEnumerable<CampaignResumeSellOut>> GetCampaignResumeSellOutsAsync(CampaignParams campaign)
        {
            ...
            SELECT
                ...
                uvwPes.RazaoSocial    AS RazaoSocial,
                tblConVen.IDProduto   AS IdProduct,
                vwPro.DescProduto     AS ProductDescription,
                vwPro.CodBarras       AS Ean,
                SUM(tblConVen.Quantidade) AS Quantidade,
                SUM(tblConVen.Total)      AS Total,
                tblConVen.IDPessoaVendedor AS IdSeller,
            ...
            GROUP BY
                ...
                vwPro.CodBarras, tblConVen.IDPessoaVendedor, uvwPesVen.Nome, vwPro.DescProduto
            ...
            GROUP BY
                uvwPes.CpfCnpj, uvwPes.RazaoSocial, tblConVen.IDProduto,
                vwPro.DescProduto, vwPro.CodBarras, tblConVen.IDPessoaVendedor, tblSegUsu.NomeUsuario";
